...
function problemA() {
    ...
    Promise.each(['poem-two/stanza-01.txt', 'poem-two/stanza-02.txt'], function(file) {
        return promisifiedReadFile(file).then(function(data) {
            green(data);
        })
    }).then(function() {
        console.log('done')
...
function problemC() {
    ...
    // promise version
      ...
      sequence.then(function(){console.log('done')});
